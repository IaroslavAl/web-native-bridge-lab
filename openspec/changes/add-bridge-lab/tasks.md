...
- [x] 6.3 Exercise real error/JSON/timeout/cancel/concurrency/origin/iframe/redirect/navigation/size gates and preserve durable evidence, not just temporary log paths. Final clean-source be46ee45f2fa2c0e3b2789fbbeebe5aadbc1da8a passed unit, actual operations, installed outcomes/trust/production Diagnostics, real WebKit/privacy and build/analyze gates. Observed commands/results/manifests/cleanup are retained in docs/integration/final-candidate-evidence.json; every scenario and layer limit is reconciled in docs/integration/FINAL_MATRIX.md. Historical stage-pending statements below describe their checkpoint, not missing final implemented modes. This is implementation evidence, not independent approval.
